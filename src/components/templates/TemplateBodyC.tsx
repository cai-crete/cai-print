...
export function TemplateBodyC({ page, pageIndex, purpose, onTextMouseUp, tocLabel }: { page: PageData, pageIndex: number, purpose: Purpose, onTextMouseUp?: (pageId: string, idx: number) => void, tocLabel?: string }) {
